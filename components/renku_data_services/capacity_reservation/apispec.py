...
#   timestamp: 2026-02-09T09:56:36+00:00
...
class RecurrenceConfig(BaseAPISpec):
    ...
    end_date: Optional[date] = Field(None, examples=["2024-06-15"])
...
class Occurrence(BaseAPISpec):
    ...
    start_datetime: datetime = Field(..., examples=["2024-01-15T08:00:00Z"])
    end_datetime: datetime = Field(..., examples=["2024-01-15T17:00:00Z"])
    status: OccurrenceState
    deployment_name: Optional[str] = Field(
        None, examples=["reservation-01ARZ3NDEKTSV4RRFFQ69G5FAV"]
    )
...
class OccurrenceList(RootModel[List[Occurrence]]):
    root: List[Occurrence]
