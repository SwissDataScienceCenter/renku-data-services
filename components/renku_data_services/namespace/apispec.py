...
#   timestamp: 2024-03-13T10:21:13+00:00
...
class NamespaceResponse(BaseAPISpec):
    ...
    name: Optional[str] = Field(
        None, description="Renku group name", example="My Renku Group :)", max_length=99, min_length=1
    )
    slug: str = Field(
        ...,
    ...
    creation_date: Optional[datetime] = Field(
        None,
        description="The date and time the namespace was created (in UTC and ISO-8601 format)",
...
class GroupResponse(BaseAPISpec):
    id: str = Field(..., description="ULID identifier", max_length=26, min_length=26, pattern="^[A-Z0-9]{26}$")
    name: str = Field(..., description="Renku group name", example="My Renku Group :)", max_length=99, min_length=1)
    slug: str = Field(
        ...,
        description="A command-line/url friendly name for a namespace",
        example="my-renku-namespace",
    ...
    description: Optional[str] = Field(None, description="A description for the group", max_length=500)
...
class NamespaceResponseList(RootModel[List[NamespaceResponse]]):
    root: List[NamespaceResponse] = Field(..., description="A list of Renku groups")
