...
#   timestamp: 2024-02-26T13:33:02+00:00
...
class ETag(RootModel[str]):
    root: str = Field(..., description="Entity Tag", example="9EE498F9D565D0C41E511377425F32F3")
...
class UserPreferencesPatch(BaseAPISpec):
    model_config = ConfigDict(
        extra="forbid",
    )
    pinned_projects: Optional[PinnedProjects] = None
