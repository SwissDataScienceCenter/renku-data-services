...
#   timestamp: 2024-03-04T17:17:46+00:00
...
class GroupResponse(BaseAPISpec):
    ...
    slug: str = Field(
        ...,
        description="A command-line/url friendly name for a group",
    ...
    creation_date: datetime = Field(
        ...,
        description="The date and time the group was created (in UTC and ISO-8601 format)",
