...
class _ProjectEventConverter:
    ...
    @staticmethod
    def to_events(
        project: project_models.Project | project_models.DeletedProject,
...
class _UserEventConverter:
    @staticmethod
    def to_events(
        user: user_models.UserInfo | user_models.UserInfoUpdate | user_models.DeletedUser,
        event_type: type[AvroModel] | type[events.AmbiguousEvent],
    ) -> list[Event]:
        match event_type:
...
class _GroupEventConverter:
    @staticmethod
    def to_events(
        group: group_models.Group | group_models.DeletedGroup, event_type: type[AvroModel] | type[events.AmbiguousEvent]
    ) -> list[Event]:
        if group.id is None:
