...
@dataclass
class ProjectMemberUpdated(AvroModel):
    """
    Event raised when user role on a project is modified
    """
    projectId: str
    userId: str
    role: MemberRole
    ...
    _schema: ClassVar[str] = """{
        "type": "record",
        "name": "ProjectMemberUpdated",
        "namespace": "io.renku.events.v2",
        "doc": "Event raised when user role on a project is modified",
        "fields": [
            {
                "name": "projectId",
                "type": "string"
