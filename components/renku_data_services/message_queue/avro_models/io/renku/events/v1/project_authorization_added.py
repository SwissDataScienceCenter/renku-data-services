...
@dataclass
class ProjectAuthorizationAdded(AvroModel):
    """
    Event raised when an authorization for a project is added for a user
    """
    projectId: str
    userId: str
    ...
    _schema: ClassVar[str] = """{
        "type": "record",
        "name": "ProjectAuthorizationAdded",
        "namespace": "io.renku.events.v1",
        "doc": "Event raised when an authorization for a project is added for a user",
        "fields": [
            {
                "name": "projectId",
                "type": "string"
