...
#   timestamp: 2024-09-20T13:29:30+00:00
...
class DataConnectorSecretPut(BaseAPISpec):
    name: str = Field(
        ...,
        description="Renku data connector name",
        example="My Remote Data :)",
...
class DataConnectorSecretPutList(RootModel[List[DataConnectorSecretPut]]):
    root: List[DataConnectorSecretPut] = Field(
