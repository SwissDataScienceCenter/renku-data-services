...
#   timestamp: 2026-08-05T09:02:20+00:00
...
class DataConnectorPermissions(BaseAPISpec):
    write: bool | None = Field(None, description="The user can edit the data connector")
...
class DepositLogs(RootModel[dict[str, str]]):
    root: dict[str, str]
...
class DataConnectorLinksGetQuery(PaginationRequest):
    doi: str | None = Field(
...
class DataConnectorPatch(BaseAPISpec):
    ...
    storage: CloudStorageCorePatch | None = None
