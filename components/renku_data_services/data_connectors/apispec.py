...
#   timestamp: 2025-04-04T10:22:18+00:00
...
class DataConnectorDoiPost(BaseAPISpec):
    model_config = ConfigDict(
        extra="forbid",
    )
    doi: str = Field(
        ...,
        description='A DOI (Digital Object Identifier) is composed of a DOI encoded prefix, a slash, and a DOI encoded suffix. In both parts, only letters, digits, and the characters "-", ".", "_", "~", ":", "@", "!", "$", "&", "\'", "(", ")", "*", "+", ",", ";", "=" are allowed. Every other UTF-8 char should be encoded. Refer to the [reference document](https://doi.org/10.1000/292) for further details.',
        pattern="^[-A-Za-z0-9._~:@!$&'()*+,;=]+/[-A-Za-z0-9._~:@!$&'()*+,;=]+$",
    )
    provider: Optional[str] = Field(None, description="Optional provider for the DOI.")
