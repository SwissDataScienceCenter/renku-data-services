...
#   timestamp: 2024-09-19T07:26:26+00:00
...
class DataConnectorSecretPost(BaseAPISpec):
    name: str = Field(
        ...,
        description="Renku data connector name",
        example="My Remote Data :)",
...
class DataConnectorSecretPostList(RootModel[List[DataConnectorSecretPost]]):
    root: List[DataConnectorSecretPost] = Field(
...
class DataConnector(BaseAPISpec):
    ...
    secrets: Optional[List[List[DataConnectorSecret]]] = None
    creation_date: datetime = Field(
        ...,
        description="The date and time the resource was created (in UTC and ISO-8601 format)",
        example="2023-11-01T17:32:28Z",
