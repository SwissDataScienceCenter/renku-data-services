...
#   timestamp: 2025-09-09T07:48:18+00:00
...
class UrlRedirectPlanPost(BaseAPISpec):
    ...
    source_url: str = Field(..., description="URL reference to redirect")
    target_url: str = Field(..., description="URL reference to redirect to")
...
class UrlRedirectPlan(BaseAPISpec):
    ...
    source_url: str = Field(..., description="URL reference to redirect", examples=["https://gitlab.renkulab.io/user/project", "/projects/ns/slug"])
    target_url: str = Field(..., description="URL reference to redirect to", examples=["https://github.com/user/project", "/p/project-ulid"])
