...
#   timestamp: 2026-05-29T12:10:28+00:00
...
class AuthzConfig(BaseAPISpec):
    ...
    only_admins_can_create_projects: bool = Field(
        ...,
        description="Controlls whether only admins or every user can perform a specific action.\n",
    )
    only_admins_can_create_groups: bool = Field(
        ...,
        description="Controlls whether only admins or every user can perform a specific action.\n",
    )


class AuthzConfigPatch(BaseAPISpec):
    model_config = ConfigDict(
        extra="forbid",
    )
    only_admins_can_create_projects: Optional[bool] = Field(
        None,
        description="Controlls whether only admins or every user can perform a specific action.\n",
    )
    only_admins_can_create_groups: Optional[bool] = Field(
        None,
        description="Controlls whether only admins or every user can perform a specific action.\n",
    )
