...
#   timestamp: 2026-03-13T16:50:18+00:00
...
class UserResourcePoolQuotaResponse(BaseAPISpec):
    model_config = ConfigDict(
        extra="forbid",
    )
    resource_pool_id: int
    resource_pool_name: str
    user_runtime_used: float
...
class UserResourcePoolsQuotaResponse(RootModel[List[UserResourcePoolQuotaResponse]]):
    root: List[UserResourcePoolQuotaResponse]
