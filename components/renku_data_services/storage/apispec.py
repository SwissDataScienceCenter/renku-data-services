...
#   timestamp: 2023-11-23T14:20:51+00:00
...
class CloudStorageUrl(GitRequest):
    ...
    readonly: bool = Field(True, description="Whether this storage should be mounted readonly or not")
...
class CloudStorage(GitRequest):
    ...
    name: str = Field(..., description="Name of the storage", min_length=3, pattern="^[a-zA-Z0-9_-]+$")
    configuration: Dict[str, Union[float, Optional[str], bool, Dict[str, Any]]]
...
class CloudStoragePatch(BaseAPISpec):
    ...
    name: Optional[str] = Field(None, description="Name of the storage", min_length=3, pattern="^[a-zA-Z0-9_-]+$")
    configuration: Optional[Dict[str, Union[float, Optional[str], bool, Dict[str, Any]]]] = None
    ...
    readonly: Optional[bool] = Field(None, description="Whether this storage should be mounted readonly or not")
