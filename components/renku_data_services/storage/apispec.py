...
#   timestamp: 2026-09-02T09:23:17+00:00
...
class ProjectStorageAllowPatch(BaseAPISpec):
    ...
    max_size: int | None = Field(None, description="Maximum size in GB", gt=0)
...
class ProjectIdRef(BaseAPISpec):
    model_config = ConfigDict(
        extra="forbid",
    )
    id: str = Field(
...
class ProjectSlugRef(BaseAPISpec):
    model_config = ConfigDict(
        extra="forbid",
    )
    slug: str = Field(
...
class ProjectStorageAllowPost(BaseAPISpec):
    ...
    project_ref: ProjectIdRef | ProjectSlugRef
    max_size: int = Field(..., description="Maximum size in GB", gt=0)
