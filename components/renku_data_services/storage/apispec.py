...
#   timestamp: 2023-11-23T12:56:50+00:00
...
class CloudStorage(GitRequest):
    ...
    name: str = Field(..., description="Name of the storage", min_length=3, pattern="^[a-zA-Z0-9_-]+$")
    configuration: Dict[str, Union[float, str, bool, Dict[str, Any]]]
...
class CloudStoragePatch(BaseAPISpec):
    ...
    configuration: Optional[Dict[str, Union[float, str, bool, Dict[str, Any]]]] = None
