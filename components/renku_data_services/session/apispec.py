...
#   timestamp: 2025-01-31T11:04:08+00:00
...
class EnvironmentImageSource1(Enum):
    image = "image"
...
class EnvironmentImageSource(Enum):
    image = "image"
    build = "build"


class EnvironmentImageSource2(Enum):
    build = "build"
...
class EnvironmentPost(BaseAPISpec):
    ...
    environment_image_source: EnvironmentImageSource1 = Field(
...
class BuildParameter(BaseAPISpec):
    model_config = ConfigDict(
        extra="forbid",
    )
...
class BuildParameterPost(BaseAPISpec):
    repository: str = Field(
        ...,
        description="The repository used as a basis for a custom builder",
        example="https://github.com/voila-gallery/gaussian-density",
    ...
    builder_variant: BuilderVariant
    frontend_variant: FrontendVariant
    environment_image_source: EnvironmentImageSource2
...
class Environment(BaseAPISpec):
    ...
    build_parameter: Optional[BuildParameter] = None
...
class EnvironmentPatch(BaseAPISpec):
    ...
    build_parameter: Optional[BuildParameter] = None
    environment_image_source: Optional[EnvironmentImageSource] = None
...
class SessionLauncherPost(BaseAPISpec):
    ...
    environment: Union[
        EnvironmentIdOnlyPost, Union[EnvironmentPost, BuildParameterPost]
    ]
