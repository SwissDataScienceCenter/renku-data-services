...
#   timestamp: 2024-02-12T13:52:50+00:00
...
class Session(BaseAPISpec):
    ...
    environment_id: str = Field(
        ...
        example="FROM ${RENKU_BASE_IMAGE} as builder\nARG RENKU_VERSION=2.7.0\n...\n",
        min_length=1,
    )
    project_id: Optional[str] = Field(
        None, description="ULID identifier", max_length=26, min_length=26, pattern="^[A-Z0-9]{26}$"
    )
    status: Status
