...
#   timestamp: 2026-09-09T09:29:07+00:00
...
class SecretPolicyName(StrEnum):
    disabled = "disabled"
    read = "read"
...
class LauncherSecretList(RootModel[list[Any]]):
    root: list[Any] = Field(..., description="A list of session launcher secrets")
