...
#   timestamp: 2026-09-09T12:37:36+00:00
...
class LauncherDataConnectorPatch(DataConnectorAccessPolicy):
    pass
...
class LauncherRepositoryPatch(RootModel[Any]):
    root: Any = Field(
        ..., description="Patch git repository properties of a Renku 2.0 session\n"
    )
...
class LauncherSecretPatch(SecretAccessPolicy):
    pass
...
class LauncherDataConnector(DataConnectorAccessPolicy):
...
class LauncherRepository(RepositoryAccessPolicy):
...
class LauncherSecret(SecretAccessPolicy):
    secret_slot_id: str | None = Field(
        None,
        description="ULID identifier",
        max_length=26,
        min_length=26,
...
class LauncherDataConnectorList(RootModel[list[LauncherDataConnector]]):
    root: list[LauncherDataConnector] = Field(
        ..., description="A list of data connector properties"
    )


class LauncherRepositoryList(RootModel[list[LauncherRepository]]):
    root: list[LauncherRepository]


class LauncherSecretList(RootModel[list[LauncherSecret]]):
    root: list[LauncherSecret] = Field(
