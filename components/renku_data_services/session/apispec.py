...
#   timestamp: 2025-02-07T14:41:50+00:00
...
class BuildLog(BaseAPISpec):
    process_name: Optional[str] = None
    stdout: Optional[str] = None
    stderr: Optional[str] = None


class BuildLogs(RootModel[List[BuildLog]]):
    root: List[BuildLog] = Field(..., description="The logs of a container image build")
...
class EnvironmentPost(BaseAPISpec):
    ...
    environment_image_source: EnvironmentImageSourceImage = (
        EnvironmentImageSourceImage.image
    )
