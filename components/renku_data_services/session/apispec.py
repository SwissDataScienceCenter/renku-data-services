...
#   timestamp: 2025-02-03T09:07:44+00:00
...
class EnvironmentPostInLauncher1(BaseAPISpec):
    pass


class EnvironmentPatchInLauncher1(BaseAPISpec):
    pass


class BuilderVariant(Enum):
    conda = "conda"
    pip = "pip"


class FrontendVariant(Enum):
    vscodium = "vscodium"
...
class EnvironmentImageSource(
    RootModel[Union[EnvironmentImageSourceImage, EnvironmentImageSourceBuild]]
):
    root: Union[EnvironmentImageSourceImage, EnvironmentImageSourceBuild] = Field(
...
class EnvironmentGetInLauncher1(BaseAPISpec):
...
class BuildParametersPost(BaseAPISpec):
    repository: str = Field(
        ...,
        description="The repository used as a basis for a custom builder",
        example="https://github.com/voila-gallery/gaussian-density",
...
class BuildParametersPatch(BaseAPISpec):
    ...
    builder_variant: Optional[BuilderVariant] = None
    frontend_variant: Optional[FrontendVariant] = None
    environment_image_source: EnvironmentImageSourceBuild
...
class EnvironmentGetInLauncher2(EnvironmentWithImageGet, EnvironmentGetInLauncher1):
    pass


class EnvironmentWithBuildGet(Environment):
    build_parameters: BuildParameters
    environment_image_source: EnvironmentImageSourceBuild


class EnvironmentPostInLauncher2(EnvironmentPost, EnvironmentPostInLauncher1):
    pass


class EnvironmentPostInLauncher3(BuildParametersPost, EnvironmentPostInLauncher1):
    pass


class EnvironmentPatchInLauncher2(EnvironmentPatch, EnvironmentPatchInLauncher1):
    pass


class EnvironmentPatchInLauncher3(BuildParametersPatch, EnvironmentPatchInLauncher1):
    pass
...
class SessionLauncherPost(BaseAPISpec):
    ...
    environment: Union[
        ...
        Union[EnvironmentPostInLauncher2, EnvironmentPostInLauncher3],
    ]
...
class SessionLauncherPatch(BaseAPISpec):
    ...
    environment: Optional[
        Union[
            ...
            Union[EnvironmentPatchInLauncher2, EnvironmentPatchInLauncher3],
        ]
    ] = None


class EnvironmentGetInLauncher3(EnvironmentWithBuildGet, EnvironmentGetInLauncher1):
    pass
...
class SessionLauncher(BaseAPISpec):
    ...
    environment: Union[EnvironmentGetInLauncher2, EnvironmentGetInLauncher3]
    resource_class_id: Optional[int] = Field(
