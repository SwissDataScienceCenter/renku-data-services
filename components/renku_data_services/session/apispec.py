...
#   timestamp: 2025-01-30T01:46:29+00:00
...
class BuildParameterPatch(BaseAPISpec):
    model_config = ConfigDict(
        extra="forbid",
    )
...
class EnvironmentPostInLauncher(EnvironmentPost):
    ...
    build_parameter: Optional[BuildParameterPost] = None


class EnvironmentPatchInLauncher(EnvironmentPatch):
    environment_kind: Optional[EnvironmentKind] = None
    build_parameter: Optional[BuildParameterPatch] = None
