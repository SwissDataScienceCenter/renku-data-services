...
#   filename:  <stdin>
#   timestamp: 2024-07-13T15:44:04+00:00
...
class Oidc(BaseCRD):
    ...
    authorizedEmails: List[str] = Field(
        [],
    ...
    authorizedGroups: List[str] = Field(
        [],
...
class JupyterServer(BaseCRD):
    ...
    hibernated: bool = Field(
        False, description="Whether the server is hibernated or not."
    )
...
class Routing(BaseCRD):
    ...
    ingressAnnotations: Dict[str, Any] = {}
    path: str = Field(
...
class Spec(BaseCRD):
    ...
    culling: Culling = Field({}, description="Options about culling idle servers")
