...
#   filename:  https://raw.githubusercontent.com/opencontainers/image-spec/refs/tags/v1.1.1/schema/image-manifest-schema.json
#   timestamp: 2025-11-06T08:57:18+00:00
...
class ImageManifest(BaseOciModel):
    model_config = ConfigDict(
        extra="allow",
    )
    ...
    layers: Sequence[ContentDescriptor] = Field(..., min_length=1)
    annotations: Optional[Mapping[str, str]] = None
