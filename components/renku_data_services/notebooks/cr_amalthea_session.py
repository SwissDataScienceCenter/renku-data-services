...
#   filename:  <stdin>
#   timestamp: 2026-04-24T15:13:08+00:00
...
class CpuIdleThreshold(RootModel[int]):
    root: int = Field(
        ...,
        description="Number of CPU cores that determine a session to be idling.",
        pattern="^(\\+|-)?(([0-9]+(\\.[0-9]*)?)|(\\.[0-9]+))(([KMGTPE]i)|[numkMGTPE]|([eE](\\+|-)?(([0-9]+(\\.[0-9]*)?)|(\\.[0-9]+))))?$",
    )


class CpuIdleThreshold1(RootModel[str]):
    root: str = Field(
        ...,
        description="Number of CPU cores that determine a session to be idling.",
        pattern="^(\\+|-)?(([0-9]+(\\.[0-9]*)?)|(\\.[0-9]+))(([KMGTPE]i)|[numkMGTPE]|([eE](\\+|-)?(([0-9]+(\\.[0-9]*)?)|(\\.[0-9]+))))?$",
...
class Culling(BaseCRD):
    ...
    cpuIdleThreshold: Union[CpuIdleThreshold, CpuIdleThreshold1] = Field(
        default="300m",
        description="Number of CPU cores that determine a session to be idling.",
    )
    lastInteraction: Optional[datetime] = Field(
        default=None,
        description="A timestamp denoting the time when a user has proven to have interacted with the session,\npreventing it from culling. The greater of this timestamp and `status.IdleSince` is used\nto count down `MaxIdleDuration`.",
    )
...
class Ingress(BaseCRD):
    ...
    useDefaultClusterTLSCert: bool = Field(
        default=False,
...
class Status(BaseCRD):
    ...
    willHibernateAt: Optional[datetime] = Field(
        default=None, description="The date-time when the session is hibernated."
    )
