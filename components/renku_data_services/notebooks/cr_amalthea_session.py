...
#   filename:  <stdin>
#   timestamp: 2024-08-10T18:37:51+00:00
...
class Authentication(BaseCRD):
    ...
    extraVolumeMounts: Optional[List[ExtraVolumeMount]] = Field(
        None, description="Additional volume mounts for the authentication container."
    )
...
class Session(BaseCRD):
    ...
    shmSize: Optional[Union[int, str]] = Field(None, description="Size of /dev/shm")
    storage: Storage = {}
    urlPath: str = Field(
        "/",
