...
#   timestamp: 2024-08-07T13:42:10+00:00
...
class NotebookResponseAmaltheaSession(BaseAPISpec):
    cloudstorage: Optional[List[LaunchNotebookResponseCloudStorage]] = None
    image: Optional[str] = None
    name: Optional[str] = None
    resources: Optional[UserPodResources] = None
...
class NotebookResponseAmaltheaSessionList(
    RootModel[List[NotebookResponseAmaltheaSession]]
):
    root: List[NotebookResponseAmaltheaSession]
