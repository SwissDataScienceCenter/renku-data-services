...
#   timestamp: 2026-07-08T14:16:20+00:00
...
class RemoteConfigurationFirecrestPatch(BaseAPISpec):
    ...
    kind: Kind17 | None = Field(None, description="Kind of remote resource pool", examples=["firecrest"])
...
class RemoteConfigurationRunaiPatch(BaseAPISpec):
    model_config = ConfigDict(
        extra="forbid",
    )
    kind: Kind18 | None = Field(None, description="Kind of remote resource pool", examples=["runai"])
    base_url: str | None = Field(
        None,
        description="The base URL of the Runai server",
        examples=["https://sdsc.run.ai"],
    )
    provider_id: str | None = Field(
        None,
        description="The ID of a provider (see oauth2 section).\nThis is used to allow seamless authentication using Renku integrations.\n",
...
class NodeAffinityListResponse(RootModel[list[NodeAffinity] | None]):
    root: list[NodeAffinity] | None = Field(
        [],
...
class Error(BaseAPISpec):
    ...
    detail: str | None = Field(None, examples=["A more detailed optional message showing what the problem was"])
...
class ResourcePoolsParams(BaseAPISpec):
    ...
    gpu: int = Field(0, description="Number of GPUs", examples=[8], ge=0, le=9223372036854775807)
    memory: int = Field(
        0,
...
class ResourcePoolsGetParametersQuery(BaseAPISpec):
    resource_pools_params: ResourcePoolsParams | None = None
...
class ResourcePoolsResourcePoolIdClassesGetParametersQuery(BaseAPISpec):
    resource_class_params: ResourceClassParams | None = None
...
class UsersUserIdResourcePoolsGetParametersQuery(BaseAPISpec):
    user_resource_params: UserResourceParams | None = None
...
class Cluster(BaseAPISpec):
    ...
    session_host: str = Field(..., max_length=256, pattern="^([0-9a-zA-Z:_-]+[.])*[0-9a-zA-Z:_-]+$")
    session_port: int = Field(..., ge=0, le=65536)
    session_path: str
    session_ingress_class_name: str | None = Field(None, max_length=256)
    session_ingress_annotations: IngressAnnotations
    session_tls_secret_name: str | None = Field(None, max_length=256)
    session_storage_class: str | None = Field(None, max_length=256)
...
class ClusterPatch(BaseAPISpec):
    ...
    session_protocol: Protocol | None = None
    session_host: str | None = Field(None, max_length=256, pattern="^([0-9a-zA-Z:_-]+[.])*[0-9a-zA-Z:_-]+$")
    session_port: int | None = Field(None, ge=0, le=65536)
    session_path: str | None = None
    session_ingress_class_name: str | None = Field(None, max_length=256)
    session_ingress_annotations: IngressAnnotations | None = None
    session_tls_secret_name: str | None = Field(None, max_length=256)
    session_storage_class: str | None = Field(None, max_length=256)
    service_account_name: str | None = Field(
        None,
    ...
    session_ingress_use_default_cluster_tls_cert: bool | None = None
...
class PoolMemberUser(BaseAPISpec):
    model_config = ConfigDict(
        extra="forbid",
    )
    member_type: Literal["user"] = "user"
    id: str = Field(
        ...,
        description="Keycloak user ID",
        examples=["f74a228b-1790-4276-af5f-25c2424e9b0c"],
...
class PoolMemberGroup(BaseAPISpec):
    model_config = ConfigDict(
        extra="forbid",
    )
    member_type: Literal["group"] = "group"
    id: str = Field(
        ...,
        description="ULID identifier",
        max_length=26,
...
class PoolMemberProject(BaseAPISpec):
    model_config = ConfigDict(
        extra="forbid",
    )
    member_type: Literal["project"] = "project"
    id: str = Field(
        ...,
        description="ULID identifier",
        max_length=26,
...
class PoolMembers(
    RootModel[
        list[
            Annotated[
                PoolMemberUser | PoolMemberGroup | PoolMemberProject,
...
class PoolMemberUserResponse(BaseAPISpec):
    model_config = ConfigDict(
        extra="forbid",
    )
    member_type: Literal["user"] = "user"
...
class PoolMemberGroupResponse(BaseAPISpec):
    model_config = ConfigDict(
        extra="forbid",
    )
    member_type: Literal["group"] = "group"
...
class PoolMemberProjectResponse(BaseAPISpec):
    model_config = ConfigDict(
        extra="forbid",
    )
    member_type: Literal["project"] = "project"
    ...
    role: Role5
    namespace: str = Field(..., description="Full project namespace path (e.g. user/project)")
    name: str


class PoolMembersResponse(
    RootModel[
        list[
            Annotated[
                PoolMemberUserResponse | PoolMemberGroupResponse | PoolMemberProjectResponse,
                Field(discriminator="member_type"),
            ]
        ]
    ]
...
class QuotaPatch(BaseAPISpec):
    ...
    cpu: float | None = Field(None, description="Number of cpu cores", examples=[10], gt=0.0)
    ...
    gpu: int | None = Field(None, description="Number of GPUs", examples=[8], ge=0, le=9223372036854775807)
...
class QuotaWithId(BaseAPISpec):
    ...
    gpu: int = Field(..., description="Number of GPUs", examples=[8], ge=0, le=9223372036854775807)
    id: str = Field(
        ...,
        description="A name for a specific resource",
        examples=["the name of a resource"],
...
class RemoteConfigurationFirecrest(BaseAPISpec):
    ...
    kind: Kind15 = Field(..., description="Kind of remote resource pool", examples=["firecrest"])
    provider_id: str | None = Field(
        None,
        description="The ID of a provider (see oauth2 section).\nThis is used to allow seamless authentication using Renku integrations.\n",
        examples=["my-provider"],
...
class RemoteConfigurationRunai(BaseAPISpec):
    ...
    kind: Kind16 = Field(..., description="Kind of remote resource pool", examples=["runai"])
    base_url: str = Field(
        ...,
        description="The base URL of the Runai server",
        examples=["https://sdsc.run.ai"],
...
class ResourceClassProperties(BaseAPISpec):
    model_config = ConfigDict(
        extra="forbid",
    )
    name: str = Field(
...
class ResourceClassPropertiesPatch(BaseAPISpec):
    model_config = ConfigDict(
        extra="forbid",
    )
    name: str | None = Field(
...
class LocalResourceClass(ResourceClassProperties):
    model_config = ConfigDict(
        extra="forbid",
    )
    kind: Literal["local"] = Field("local", examples=["local"])


class FirecrestResourceClass(ResourceClassProperties):
    model_config = ConfigDict(
        extra="forbid",
    )
    kind: Literal["firecrest"] = Field("firecrest", examples=["firecrest"])
    cpu: int | None = Field(
        None,
...
class RunaiResourceClass(ResourceClassProperties):
    model_config = ConfigDict(
        extra="forbid",
    )
    kind: Literal["runai"] = Field("runai", examples=["runai"])


class LocalResourceClassPatch(ResourceClassPropertiesPatch):
    model_config = ConfigDict(
        extra="forbid",
    )
    kind: Literal["local"] = Field("local", examples=["local"])
...
class FirecrestResourceClassPatch(ResourceClassPropertiesPatch):
    model_config = ConfigDict(
        extra="forbid",
    )
    kind: Literal["firecrest"] = Field("firecrest", examples=["firecrest"])
...
class RunaiResourceClassPatch(ResourceClassPropertiesPatch):
    model_config = ConfigDict(
        extra="forbid",
    )
    kind: Literal["runai"] = Field("runai", examples=["runai"])
...
class ResourceClassPatch(RootModel[LocalResourceClassPatch | FirecrestResourceClassPatch | RunaiResourceClassPatch]):
    root: LocalResourceClassPatch | FirecrestResourceClassPatch | RunaiResourceClassPatch = Field(
        ..., discriminator="kind"
    )


class LocalResourceClassPatchWithId(ResourceClassPropertiesPatch):
    model_config = ConfigDict(
        extra="forbid",
    )
    id: int = Field(
...
class FirecrestResourceClassPatchWithId(ResourceClassPropertiesPatch):
    model_config = ConfigDict(
        extra="forbid",
    )
    id: int = Field(
...
class RunaiResourceClassPatchWithId(ResourceClassPropertiesPatch):
    model_config = ConfigDict(
        extra="forbid",
    )
    id: int = Field(
...
class LocalResourceClassWithId(ResourceClassProperties):
    model_config = ConfigDict(
        extra="forbid",
    )
    id: int = Field(
...
class FirecrestResourceClassWithId(ResourceClassProperties):
    model_config = ConfigDict(
        extra="forbid",
    )
    id: int = Field(
...
class RunaiResourceClassWithId(ResourceClassProperties):
    model_config = ConfigDict(
        extra="forbid",
    )
    id: int = Field(
...
class LocalResourceClassWithIdFiltered(ResourceClassProperties):
    model_config = ConfigDict(
        extra="forbid",
    )
    id: int = Field(
    ...
    usage_hours_remaining: float | None = Field(
        None,
        description="Number of resource hours remaining for the user",
        examples=[3.141],
        ge=0.0,
    )
    usage_hours_total: float | None = Field(
        None,
        description="Total number of resource hours available to the user",
        examples=[10],
        ge=0.0,
    )
    name: str = Field(
...
class FirecrestResourceClassWithIdFiltered(ResourceClassProperties):
    model_config = ConfigDict(
        extra="forbid",
    )
    id: int = Field(
...
class RunaiResourceClassWithIdFiltered(ResourceClassProperties):
    model_config = ConfigDict(
        extra="forbid",
    )
    id: int = Field(
...
class ResourceClassesWithIdResponse(
    RootModel[
        list[
            Annotated[
                LocalResourceClassWithId | FirecrestResourceClassWithId | RunaiResourceClassWithId,
...
class ResourcePoolPatch(BaseAPISpec):
    ...
    quota: QuotaPatch | None = None
    classes: (
        list[
            Annotated[
                LocalResourceClassPatchWithId | FirecrestResourceClassPatchWithId | RunaiResourceClassPatchWithId,
                Field(discriminator="kind"),
            ]
        ]
        | None
...
class ResourcePool(BaseAPISpec):
    ...
    quota: QuotaWithOptionalId | None = None
    classes: list[
        Annotated[
            LocalResourceClass | FirecrestResourceClass | RunaiResourceClass,
            Field(discriminator="kind"),
        ]
    ]
    name: str = Field(
    ...
    remote: RemoteConfigurationFirecrest | RemoteConfigurationRunai | None = Field(
        None,
...
class ResourcePoolWithIdFiltered(BaseAPISpec):
    ...
    classes: list[
        Annotated[
            LocalResourceClassWithIdFiltered | FirecrestResourceClassWithIdFiltered | RunaiResourceClassWithIdFiltered,
            Field(discriminator="kind"),
        ]
    ]
    name: str = Field(
    ...
    credits_used: int | None = Field(
        None,
        description="Amount of the resource credits used so far",
        examples=[300],
        ge=0,
    )
...
class ResourceClass(RootModel[LocalResourceClass | FirecrestResourceClass | RunaiResourceClass]):
    root: LocalResourceClass | FirecrestResourceClass | RunaiResourceClass = Field(..., discriminator="kind")


class ResourceClassWithId(
    RootModel[LocalResourceClassWithId | FirecrestResourceClassWithId | RunaiResourceClassWithId]
):
    root: LocalResourceClassWithId | FirecrestResourceClassWithId | RunaiResourceClassWithId = Field(
        ..., discriminator="kind"
    )
