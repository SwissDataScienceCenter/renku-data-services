...
#   timestamp: 2025-11-17T08:49:22+00:00
...
class ContainerRuntimePlatform(BaseAPISpec):
    architecture: str = Field(
        ..., description='The platform architecture, e.g. "amd64".', examples=["amd64"]
    )
    os: str = Field(
        ...,
        description='The platform\'s operating system, e.g. "linux".',
        examples=["linux"],
    )
    os_version: Optional[str] = Field(None, alias="os.version")
    os_features: Optional[List[str]] = Field(None, alias="os.features")
    variant: Optional[str] = Field(
        None, description='The platform\'s variant, e.g. "v2".', examples=["v2"]
    )
...
class ResourcePoolPatch(BaseAPISpec):
    ...
    platform: Optional[ContainerRuntimePlatform] = None
...
class ResourcePool(BaseAPISpec):
    ...
    platform: ContainerRuntimePlatform
