...
class Quota(BaseAPISpec):
    ...
    memory: int = Field(..., description="Number of gigabytes of memory", example=4, gt=0, le=9223372036854775807)
...
class QuotaPatch(BaseAPISpec):
    ...
    memory: Optional[int] = Field(
        None, description="Number of gigabytes of memory", example=4, gt=0, le=9223372036854775807
    )
...
class ResourceClass(BaseAPISpec):
    ...
    max_storage: int = Field(
        ..., description="Number of gigabytes of storage", example=100, gt=0, le=9223372036854775807
    )
...
class ResourceClassPatch(BaseAPISpec):
    ...
    max_storage: Optional[int] = Field(
        None, description="Number of gigabytes of storage", example=100, gt=0, le=9223372036854775807
    )
