...
#   timestamp: 2026-01-15T12:13:55+00:00
...
class ResourceClassesWithId(RootModel[List[ResourceClassWithId]]):
...
class ResourceClassWithIdWithoutResourcePoolId(ResourceClass):
    id: int = Field(
        ...,
        description="An integer ID used to identify different resources",
        examples=[1],
...
class ResourcePoolPut(BaseAPISpec):
    ...
    classes: List[ResourceClassWithIdWithoutResourcePoolId]
    name: str = Field(
        ...,
        description="A name for a specific resource",
        examples=["the name of a resource"],
