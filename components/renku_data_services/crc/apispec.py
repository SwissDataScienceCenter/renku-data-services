...
#   timestamp: 2025-09-18T11:59:29+00:00
...
class ResourcePoolPatch(BaseAPISpec):
    ...
    remote: Optional[bool] = Field(
        False,
        description="A resource pool which starts sessions remotely",
        examples=[False],
    )
    remote_provider_id: Optional[str] = Field(
        None,
        description="The ID of a provider (see oauth2 section)",
        examples=["my-provider"],
    )
    remote_configuration: Optional[RemoteConfigurationFirecrestPatch] = Field(
        None,
...
class ResourcePool(BaseAPISpec):
    ...
    remote_configuration: Optional[RemoteConfigurationFirecrest] = Field(
        None, description="The configuration used by to start sessions remotely"
    )
    idle_threshold: Optional[int] = Field(
        None,
        description="A threshold in seconds after which a session gets hibernated (0 means no threshold)",
