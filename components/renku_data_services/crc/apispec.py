...
#   timestamp: 2026-09-15T12:53:22+00:00
...
class RemoteConfigurationRunners(BaseAPISpec):
    model_config = ConfigDict(
        extra="forbid",
    )
    kind: Kind2 = Field(
        ..., description="Kind of remote resource pool", examples=["runners"]
    )
...
class RemoteConfigurationRunnersPatch(BaseAPISpec):
    model_config = ConfigDict(
        extra="forbid",
    )
    kind: Kind5 | None = Field(
        None, description="Kind of remote resource pool", examples=["runners"]
    )
...
class ResourcePoolPatch(BaseAPISpec):
    ...
    remote: (
        ...
        | RemoteConfigurationRunnersPatch
        | None
    ) = Field(
        None,
