...
#   timestamp: 2026-05-21T08:46:22+00:00
...
class ResourceClassWithIdFiltered(ResourceClassWithId):
    ...
    usage_hours_remaining: Optional[float] = Field(
        None,
        description="Number of resource hours remaining for the user",
        examples=[3.141],
        ge=0.0,
    )
    usage_hours_total: Optional[float] = Field(
        None,
...
class ResourcePool(BaseAPISpec):
    ...
    remote: Optional[Union[RemoteConfigurationFirecrest, RemoteConfigurationRunai]] = (
        Field(
            None,
