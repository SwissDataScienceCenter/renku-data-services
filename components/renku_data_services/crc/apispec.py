...
#   timestamp: 2026-09-21T12:38:33+00:00
...
class RemoteConfigurationRunaiPatch(BaseAPISpec):
    ...
    kind: Kind3 | None = Field(
        None, description="Kind of remote resource pool", examples=["runai"]
    )
...
class ResourceFlavourParams(BaseAPISpec):
    model_config = ConfigDict(
        extra="forbid",
    )
    name: str | None = Field(
...
class ResourceFlavoursGetParametersQuery(BaseAPISpec):
    resource_flavour_params: ResourceFlavourParams | None = None
...
class ResourceFlavour(BaseAPISpec):
    model_config = ConfigDict(
        extra="forbid",
    )
    name: str = Field(
    ...
    description: str | None = Field(
        None,
        description="Why a resource flavour is sized the way it is",
        examples=["Fits a standard node with room for the daemonset"],
        max_length=500,
    )
...
class ResourceFlavourWithId(BaseAPISpec):
    model_config = ConfigDict(
        extra="forbid",
    )
    id: str = Field(
...
class ResourceFlavourPatch(BaseAPISpec):
    model_config = ConfigDict(
        extra="forbid",
    )
    name: str | None = Field(
...
class ResourceFlavoursWithId(RootModel[list[ResourceFlavourWithId]]):
    root: list[ResourceFlavourWithId]


class LinkedResourceClass(BaseAPISpec):
    model_config = ConfigDict(
        extra="forbid",
    )
    id: int = Field(
    ...
    resource_pool_id: int | None = Field(
        None,
        description="An integer ID used to identify different resources",
        examples=[1],
        ge=0,
    )
    resource_pool_name: str | None = Field(
        None,
        description="A name for a specific resource",
        examples=["the name of a resource"],
        min_length=5,
...
class LinkedResourceClassesList(RootModel[list[LinkedResourceClass]]):
    root: list[LinkedResourceClass]
...
class PoolMemberProjectResponse(BaseAPISpec):
    ...
    role: Role5
    namespace: str = Field(
        ..., description="Full project namespace path (e.g. user/project)"
    )
    name: str
...
class RemoteClassConfigurationFirecrest(BaseAPISpec):
    ...
    forward_resource_values: bool = Field(
        False,
...
class RemoteConfigurationRunai(BaseAPISpec):
    ...
    kind: Kind1 = Field(
        ..., description="Kind of remote resource pool", examples=["runai"]
    )
    base_url: str = Field(
        ...,
        description="The base URL of the Runai server",
...
class ResourceClassProperties(BaseAPISpec):
    ...
    resource_flavour_id: str | None = Field(
        None,
        description="The resource flavour this resource class is linked to",
        max_length=26,
        min_length=26,
        pattern="^[0-7][0-9A-HJKMNP-TV-Z]{25}$",
    )
...
class ResourceClassFromFlavour(BaseAPISpec):
    model_config = ConfigDict(
        extra="forbid",
    )
    name: str = Field(
...
class ResourceClassCreate(RootModel[ResourceClassFromFlavour | ResourceClass]):
    root: ResourceClassFromFlavour | ResourceClass = Field(
        ...,
        description="A new resource class. Set `resource_flavour_id` to take cpu, memory, gpu and storage from\na resource flavour, or set those values directly. `name` is required either way.\n",
    )
...
class ResourcePoolPatch(BaseAPISpec):
    ...
    classes: list[ResourceClassPatchWithId] | None = Field(
        None,
        examples=[
            [
...
class ResourcePool(BaseAPISpec):
    ...
    classes: list[ResourceClassFromFlavour | ResourceClass]
    name: str = Field(
        ...,
        description="A name for a specific resource",
        examples=["the name of a resource"],
