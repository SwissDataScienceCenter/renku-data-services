...
#   timestamp: 2026-05-01T14:32:37+00:00
...
class PoolMemberGroup(BaseAPISpec):
    ...
    member_type: Literal["group"]
    id: str = Field(..., description="Group id (ULID)", examples=["01ARZ3NDEKTSV4RRFFQ69G5FAV"])
    relation: Relation1


class MemberType2(Enum):
    project = "project"
...
class PoolMemberProject(BaseAPISpec):
    ...
    member_type: Literal["project"]
    id: str = Field(..., description="Project id (ULID)", examples=["01ARZ3NDEKTSV4RRFFQ69G5FAW"])
    relation: Relation2
...
class RemoteConfigurationFirecrestPatch(BaseAPISpec):
    ...
    kind: Optional[Kind2] = Field(None, description="Kind of remote resource pool", examples=["firecrest"])
...
class RemoteConfigurationRunaiPatch(BaseAPISpec):
    ...
    kind: Optional[Kind3] = Field(None, description="Kind of remote resource pool", examples=["runai"])
...
class ClusterPatch(BaseAPISpec):
    ...
    session_host: Optional[str] = Field(None, max_length=256, pattern="^([0-9a-zA-Z:_-]+[.])*[0-9a-zA-Z:_-]+$")
...
class PoolMembers(RootModel[List[Union[PoolMemberUser, PoolMemberGroup, PoolMemberProject]]]):
    root: List[Union[PoolMemberUser, PoolMemberGroup, PoolMemberProject]]
...
class QuotaPatch(BaseAPISpec):
    ...
    cpu: Optional[float] = Field(None, description="Number of cpu cores", examples=[10], gt=0.0)
    ...
    gpu: Optional[int] = Field(None, description="Number of GPUs", examples=[8], ge=0, le=9223372036854775807)
...
class RemoteConfigurationFirecrest(BaseAPISpec):
    ...
    kind: Kind = Field(..., description="Kind of remote resource pool", examples=["firecrest"])
    provider_id: Optional[str] = Field(
        None,
        description="The ID of a provider (see oauth2 section).\nThis is used to allow seamless authentication using Renku integrations.\n",
        examples=["my-provider"],
...
class RemoteConfigurationRunai(BaseAPISpec):
    ...
    kind: Kind1 = Field(..., description="Kind of remote resource pool", examples=["runai"])
    base_url: str = Field(
        ...,
        description="The base URL of the Runai server",
        examples=["https://sdsc.run.ai"],
...
class ResourcePool(BaseAPISpec):
    ...
    remote: Optional[Union[RemoteConfigurationFirecrest, RemoteConfigurationRunai]] = Field(
        None,
