...
#   timestamp: 2026-05-13T07:20:14+00:00
...
class PoolMemberGroup(BaseAPISpec):
    ...
    id: str = Field(
        ..., description="Group id (ULID)", examples=["01ARZ3NDEKTSV4RRFFQ69G5FAV"]
    )
    relation: Relation1
...
class PoolMemberProject(BaseAPISpec):
    ...
    id: str = Field(
        ..., description="Project id (ULID)", examples=["01ARZ3NDEKTSV4RRFFQ69G5FAW"]
    )
    relation: Relation2
