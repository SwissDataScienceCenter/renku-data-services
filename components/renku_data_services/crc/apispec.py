...
#   timestamp: 2026-08-06T15:16:39+00:00
...
class RemoteClassConfigurationFirecrest(BaseAPISpec):
    ...
    ignore_resource_class_values: bool = Field(
        False,
        description="When true, Amalthea will not pass the resource class CPU, memory, or GPU values to FirecREST. The HPC grid will select the resources. The class values are still used for display and quota matching.\n",
    )
