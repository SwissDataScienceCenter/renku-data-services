...
def test_env_variable_validation():
    ...
    validation_result = validate_env_variables(renku_name_env_variables)
    ...
    validation_result = validate_env_variables(non_posix_name_env_variables)
    assert len(validation_result) == 2
    assert validation_result[0] == "Env variable name '1foo' must match the regex '^[a-zA-Z_][a-zA-Z0-9_]*$'."
