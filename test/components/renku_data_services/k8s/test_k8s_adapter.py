...
from renku_data_services.notebooks.api.classes.k8s_client import BaseK8sClient
...
def test_patch_statefulset_tokens() -> None:
    ...
    patches = BaseK8sClient._get_statefulset_token_patches(StatefulSet(sanitized_sts), new_renku_tokens)
